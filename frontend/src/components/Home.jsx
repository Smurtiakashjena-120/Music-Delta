...
<div className=" flex items-center justify-center w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ">
        ...
        <ShowSongs playSong={playSong} toPlaylist={toPlaylist} songArray={songArray} filteredObjects={filteredObjects} />
...
function ShowSongs({  playSong,toPlaylist ,songArray,filteredObjects}) {
...
Trending....
    ...
    <div className="p-6 pt-0">
        <button onClick={() => playSong(song)} className="align-middle select-none font-sans font-bold text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 px-6 rounded-lg bg-gray-900 text-white shadow-md shadow-gray-900/10 hover:shadow-lg hover:shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none">Play</button>
    </div>
{/* svg  for liked song */}
<svg xmlns="http://www.w3.org/2000/svg"  className="absolute top-5 right-5 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" data-clicked = "false" onClick={(event) => handleClr(event.currentTarget)}>
